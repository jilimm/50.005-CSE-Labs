...
//you need to try both ECB and CBC mode, use PKCS5Padding padding method
        Cipher ecipher = Cipher.getInstance("DES/CCB/PKCS5Padding");
        ...
        // convert each column int[] into a byte[] (each_width_pixel)
            ...
            for(int idy = 0; idy < image_length; idy++) {
                ...
                byte[] img_bytes = dbuf.array();
                System.arraycopy(img_bytes, 0, each_width_pixel, idy*4, 4);
           }
...
//write outImage into file
        ImageIO.write(outImage, "BMP",new File("CCB_EnSUTD.bmp"));
