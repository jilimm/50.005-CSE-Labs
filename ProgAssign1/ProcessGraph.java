...
public class ProcessGraph {
    ...
    //checks if all the nodes in the Process Graph have been executed
    //returns boolean value, true--> all finished, all processes terminated.
    //false if some processes have yet to be executed
